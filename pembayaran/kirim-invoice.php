    ...
    <div class="alert alert-info" style="margin-bottom: 25px; border-left: 5px solid #3b82f6;">
        ...
        <ol style="margin-bottom: 0; padding-left: 20px;">
            ...
            <li>Di halaman invoice:
                <ul>
                    <li><strong>Browser:</strong> Klik tombol WhatsApp. Caption otomatis terisi dan gambar invoice disalin; di chat siswa tekan <strong>Ctrl+V</strong>, lalu klik <strong>Kirim</strong>.</li>
                    <li><strong>Aplikasi HP:</strong> Klik tombol WhatsApp untuk mengirim gambar melalui aplikasi native.</li>
                </ul>
            </li>
        </ol>
    </div>
